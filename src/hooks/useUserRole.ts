...
export type AppRole = 'admin' | 'teacher' | 'student' | 'therapist' | 'parent' | 'patient' | 'user';
...
export function useUserRole() {
  ...
  useEffect(() => {
    ...
    const fetchRoles = async () => {
      try {
        ...
        const roleHierarchy: AppRole[] = ['admin', 'teacher', 'student', 'therapist', 'parent', 'patient', 'user'];
  ...
  const isStudent = hasRole('student') || hasRole('patient');
