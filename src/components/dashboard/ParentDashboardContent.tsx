  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-8">
        ...
        <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => navigate('/games/quebra-cabeca-magico')}>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div><h3 className="font-semibold">Quebra-Cabeça Mágico</h3><p className="text-sm text-muted-foreground">Jogo de lógica para estimular o raciocínio</p></div>
            </div>
          </CardContent>
        </Card>
